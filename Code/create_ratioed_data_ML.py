...
D = np.loadtxt('../Data/ML/Similarity_Matrix_Drugs.txt')
T = np.loadtxt('../Data/ML/Similarity_Matrix_Viruses.txt')
with open('../Data/ML/Y.npy', 'rb') as f:
    Y = np.load(f)

with open('../Data/ML/Xindex.npy', 'rb') as f:
    XIndex = np.load(f)
